...
import { X, ExternalLink, Github, CheckCircle2, Trash2, Loader2 } from 'lucide-react';
        ...
        <div style={{ padding: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            {onDelete && (
              ...
              >
                {isDeleting ? <Loader2 size={16} style={{ animation: 'spin 1s linear infinite' }} /> : <Trash2 size={16} />} Delete Project
              </button>
            )}
          </div>
